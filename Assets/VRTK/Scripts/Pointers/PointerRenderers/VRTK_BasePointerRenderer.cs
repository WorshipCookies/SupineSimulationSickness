...
namespace VRTK
{
    ...
    public abstract class VRTK_BasePointerRenderer : MonoBehaviour
    {
        ...
        protected virtual void ChangeColor(Color givenColor, GameObject customCursor, Material givenMaterial)
        {
            ...
            if ((playareaCursor != null && playareaCursor.IsActive() && playareaCursor.HasCollided()) || !ValidDestination() || (controllingPointer != null && !controllingPointer.CanSelect()))
            {
                ...
                //givenMaterial = invalidMaterial;
            }

            if (givenColor != Color.clear)
            {
                currentColor = givenColor;
                ChangeMaterial(givenColor, givenMaterial);
            }
        ...
        protected virtual void ChangeMaterialColor(GameObject givenObject, Color givenColor, Material givenMaterial)
        {
            if (givenObject != null)
            {
