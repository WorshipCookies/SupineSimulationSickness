...
namespace VRTK
{
    ...
    public class VRTK_Pointer : VRTK_DestinationMarker
    {
        ...
        {
            //Debug.Log("attemptControllerSetup is " + attemptControllerSetup);
            if (attemptControllerSetup)
            {
                //Debug.Log("FindController() is " + FindController());
                if (FindController())
                {
                    attemptControllerSetup = false;
                    SetupController();
                    SetupRenderer();
                    //Debug.Log("activateOnEnable is " + activateOnEnable);
                    if (activateOnEnable)
                    {
                        Toggle(true);
                    }
        ...
        protected virtual void SetupController()
        {
            ...
            {
                //Debug.Log("Controller null, no setup");
            }
        }
        ...
        protected virtual void DoActivationButtonPressed(object sender, ControllerInteractionEventArgs e)
        {
            ...
            //Debug.Log("EnabledPointerRenderer() : " + EnabledPointerRenderer());
            if (EnabledPointerRenderer())
            {
        ...
        protected virtual void ManageActivationState(bool state)
        {
            ...
            Debug.Log("currentActivationState : " + currentActivationState);
        }
