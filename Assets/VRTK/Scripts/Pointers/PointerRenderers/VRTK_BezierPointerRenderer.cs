...
namespace VRTK
{
    ...
    public class VRTK_BezierPointerRenderer : VRTK_BasePointerRenderer
    {
        ...
        {
            //Debug.Log("controllingPointer : " + controllingPointer);
            //Debug.Log("controllingPointer.IsPointerActive() : " + controllingPointer.IsPointerActive());
            //Debug.Log("IsVisible() : " + IsVisible());

            //if controller being used
            if ((controllingPointer && controllingPointer.IsPointerActive()) || IsVisible())
            {
                //Debug.Log("Controller being used for teleport");
        ...
        protected override void ChangeMaterial(Color givenColor, Material customMat)
        {
            base.ChangeMaterial(givenColor, customMat);
            ChangeMaterialColor(actualCursor, givenColor, customMat);
        }
...
#pragma warning restore 0618
        ...
        protected virtual void SetPointerCursor()
        {
            ...
            Debug.Log("SetPointerCursor");
            //RLS.activated = true;

            //Added in order to avoid player teleporting too near from the wall
